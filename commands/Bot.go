...
import (
	...
	"github.com/barleywarley/mybot/events"
	"github.com/barleywarley/mybot/utils"
...
func (cmds *Commands) Fox(s *discordgo.Session, m *discordgo.Message, ctx *Context) {
	...
	resBody, err := utils.MakeRequest("GET", "https://raw.githubusercontent.com/charlie2krazy/fox-pics/count.txt", "", nil)
	if err != nil {
	...
	s.ChannelMessageSend(m.ChannelID, fmt.Sprintf("https://raw.githubusercontent.com/charlie2krazy/fox-pics/%d.jpg", rand.Intn(maxcount-0)+0))
}
