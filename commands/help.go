...
func (cmd *Commands) Help(s *discordgo.Session, m *discordgo.Message, ctx *Context) {
	...
	case "upvote":
		...
		certainHelp.Description = fmt.Sprintf("Updating soon..."/*, s.State.User.ID, s.State.User.ID*/)
...
func (cmd *Commands) Setup(s *discordgo.Session, m *discordgo.Message, ctx *Context) {
	...
	s.ChannelMessageSendEmbed(m.ChannelID, &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{Name: "Support:", Value: "If you need any help, click [here](https://discord.gg/bRazEdgWJY) to join the server!"},
		},
		Color: 0x36393F,
	})
...
var (
	...
	defaultHelp = &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{Name: "**Support**", Value: "For support, click [here](https://discord.gg/bRazEdgWJY)"},
		},
